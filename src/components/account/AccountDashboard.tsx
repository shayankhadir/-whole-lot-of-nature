      ...
      <div className="mx-auto max-w-5xl space-y-8">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
            ...
            <p className="mt-1 text-xs text-white/50">Across {stats.totalOrders} orders</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
            <p className="text-sm text-emerald-400">Active orders</p>
            <p className="mt-2 text-3xl font-bold text-white">{stats.activeOrders}</p>
            <p className="mt-1 text-xs text-white/50">Processing, packed, or ready to ship</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
            ...
            <p className="mt-1 text-xs text-white/50">Track from the timeline below</p>
          </div>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-md">
            ...
            {orders.length === 0 ? (
              <div className="mt-6 rounded-2xl border border-dashed border-white/20 p-6 text-center text-white/60">
          ...
          <aside className="space-y-6">
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-md">
              ...
              <p className="mt-2 text-sm text-white/70">{formatAddress(customer?.billing)}</p>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-md">
              ...
              <p className="mt-2 text-sm text-white/70">{formatAddress(customer?.shipping)}</p>
