            ...
            >
              <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-[#041008] to-[#0a1c11] p-6 text-white shadow-2xl">
                <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
                  ...
                  <button onClick={close} className="rounded-full p-1.5 text-white/60 hover:text-white">
                    <X className="h-4 w-4" />
                  </button>
                </div>
                  ...
                  <div className="mt-6 grid gap-6 md:grid-cols-[2fr_1fr]">
                    <div>
                      ...
                      <div className="mt-3 space-y-3 max-h-[420px] overflow-y-auto pr-2">
                        {isLoading && (
                          <div className="flex items-center gap-2 rounded-2xl border border-white/10 bg-white/5 px-4 py-6 text-sm text-white/70">
                        ...
                        {!isLoading && filteredResults.map((product) => (
                          ...
                          >
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              <div className="mt-3 flex flex-wrap gap-2 text-[11px] uppercase tracking-wide text-white/50">
                                ...
                                {product.tags?.slice(0, 2).map((tag) => (
                                  <span key={tag.id} className="rounded-full border border-white/10 px-2 py-0.5 text-white/60">
                                    #{tag.name}
                                  </span>
                                ))}
                              </div>
                        ...
                        {showEmptyState && (
                          <div className="rounded-2xl border border-dashed border-white/15 bg-white/5 px-6 py-10 text-center text-white/70">
                    ...
                    <aside className="space-y-5 rounded-2xl border border-white/10 bg-white/5 p-4">
                      <p className="text-xs uppercase tracking-[0.4em] text-white/50">Refine</p>
                      {renderFilters()}
