  ...
  return (
    <section className="relative py-20">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="inline-flex items-center rounded-full border border-primary-200 bg-white/70 px-4 py-1 text-xs font-semibold uppercase tracking-[0.3em] text-primary-600">
            Shop by Category
          </span>
          <h2 className="mt-6 text-4xl md:text-5xl font-semibold tracking-tight text-gray-900">
            A Luxury Edit for Every Green Vision
          </h2>
          <p className="mx-auto mt-4 max-w-3xl text-base md:text-lg text-gray-600">
            ...
            >
              <Link href={category.href} className="group flex h-full flex-col overflow-hidden rounded-3xl border border-white/50 bg-white/80 p-6 shadow-lg shadow-primary-100/20 backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:border-primary-100 hover:shadow-2xl">
                <div className={`relative flex items-center justify-between rounded-2xl bg-gradient-to-br ${category.accent} px-5 py-4 text-white`}>
                  ...
                  <div className="absolute -bottom-10 -right-10 h-24 w-24 rounded-full bg-white/20 blur-3xl" />
                </div>
                <div className="mt-5">
                  <h3 className="text-2xl font-semibold text-gray-900 group-hover:text-primary-700 transition-colors">
                    {category.title}
                  </h3>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-16 rounded-3xl border border-primary-100 bg-white/70 p-8 text-center shadow-lg"
        >
