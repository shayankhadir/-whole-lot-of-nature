      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="flex justify-center mb-6">
            <div className="bg-white/20 backdrop-blur-sm p-4 rounded-full ring-1 ring-white/30">
          ...
          <p className="text-base text-green-50 mb-6 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <motion.div
              ...
              viewport={{ once: true }}
              className="flex items-center justify-center space-x-2 text-green-50"
            >
          ...
          >
            {isSubmitted ? (
              <motion.div
                ...
                className="bg-white/15 backdrop-blur-sm rounded-lg p-6 ring-1 ring-white/20"
              >
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <div className="flex-1">
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg text-gray-900 bg-white/95 backdrop-blur-sm border border-white/20 focus:outline-none focus:ring-2 focus:ring-white/50 placeholder-gray-500"
                      required
                    />
                  </div>
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="px-6 py-3 bg-white text-green-700 font-semibold rounded-lg hover:bg-green-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
                  >
                    {isLoading ? (
