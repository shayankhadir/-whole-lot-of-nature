  ...
  return (
    <section className="relative py-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-[clamp(2rem,4vw,2.625rem)] font-montserrat font-bold text-white mb-3">
            ...
            >
              <GlassCard tint="emerald" className="h-full text-center p-6">
                <div className="flex justify-center mb-6">
                  <div className="bg-[#2E7D32]/20 p-5 rounded-2xl ring-1 ring-[#2E7D32]/30">
          ...
          <GlassCard tint="turquoise" className="p-8 text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-white">
              <div className="text-center">
                <div className="text-[clamp(1.5rem,3vw,2rem)] font-bold text-[#66BB6A]">10K+</div>
                <div className="text-sm text-white/70">Happy Customers</div>
              </div>
              <div className="text-center">
                <div className="text-[clamp(1.5rem,3vw,2rem)] font-bold text-[#66BB6A]">500+</div>
                <div className="text-sm text-white/70">Plant Varieties</div>
              </div>
              <div className="text-center">
                <div className="text-[clamp(1.5rem,3vw,2rem)] font-bold text-[#66BB6A]">50+</div>
                <div className="text-sm text-white/70">Cities Served</div>
              </div>
              <div className="text-center">
                <div className="text-[clamp(1.5rem,3vw,2rem)] font-bold text-[#66BB6A]">99%</div>
