...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden border-t border-white/10 bg-[#030a06] text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(102,187,106,0.1),transparent_60%)]" aria-hidden />
      <div className="absolute inset-0 opacity-40" aria-hidden>
        <svg className="h-full w-full" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
          <defs>
            <pattern id="leaf-grid" width="160" height="160" patternUnits="userSpaceOnUse">
              <path d="M0 80 Q40 0 80 80 T160 80" stroke="rgba(102,187,106,0.15)" strokeWidth="0.6" fill="none" />
            </pattern>
          </defs>
          ...
          <div className="grid grid-cols-2 gap-8 text-sm text-white/70 sm:grid-cols-3 lg:col-span-5">
            <div>
              ...
              <ul className="mt-4 space-y-3">
                ...
                <li>
                  <Link href="/shop/categories" className="hover:text-white">Categories</Link>
                </li>
                <li>
                  <Link href="/combos" className="hover:text-white">Combos</Link>
                </li>
                <li>
                  <Link href="/blog" className="hover:text-white">Plant journal</Link>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="mt-4 space-y-3">
                ...
                <li>
                  <Link href="/about#story" className="hover:text-white">Our story</Link>
                </li>
                <li>
                  <Link href="/about#experience" className="hover:text-white">Experience center</Link>
                </li>
                <li>
                  <Link href="/contact" className="hover:text-white">Studio visit</Link>
                </li>
              </ul>
            </div>
            <div>
