  ...
  return (
    <section className="relative isolate overflow-hidden bg-gradient-to-b from-emerald-50 via-white to-emerald-100 px-4 py-20">
      <div className="mx-auto max-w-4xl text-center">
        <p className="text-sm font-semibold uppercase tracking-[0.2em] text-emerald-500">Live beta</p>
        <h1 className="mt-4 text-4xl font-bold text-emerald-900 sm:text-5xl">
          Plantsy is now available for care questions
        </h1>
        <p className="mt-6 text-lg text-emerald-800">
