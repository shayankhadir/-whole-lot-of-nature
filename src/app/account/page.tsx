    ...
    return (
      <section className="min-h-[70vh] flex items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-emerald-100 px-4 py-16">
        <div className="w-full max-w-lg rounded-3xl bg-white p-10 text-center shadow-[0_25px_90px_-60px_rgba(5,150,105,0.8)]">
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-emerald-400">Secure customer area</p>
          <h1 className="mt-4 text-3xl font-bold text-emerald-700">Sign in to view your plant journey</h1>
          ...
          <div className="mt-8 flex flex-col gap-3">
            <Link
              href="/auth/signin"
              className="inline-flex h-12 items-center justify-center rounded-full bg-emerald-400 text-white font-semibold shadow hover:bg-emerald-500"
            >
              Continue to secure login
            </Link>
            <Link
              href="/signup"
              className="inline-flex h-12 items-center justify-center rounded-full border border-emerald-200 text-emerald-600 font-semibold"
            >
