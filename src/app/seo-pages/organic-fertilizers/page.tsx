/**
 * SEO Landing Page: Organic fertilizers: Everything You Need to Know
...
export const metadata: Metadata = {
  title: 'Organic fertilizers: Everything You Need to Know | Whole Lot of Nature',
  ...
  openGraph: {
    title: 'Organic fertilizers: Everything You Need to Know',
    description: 'Discover everything about organic fertilizers with our comprehensive guide. Expert tips, best practices, and actionable advice for organic fertilizers. Shop now!',
    type: 'article',
  },
};
      ...
      <div className="bg-white border-b">
        <div className="max-w-6xl mx-auto px-4 py-3">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-100">/</span>
            <span className="text-gray-100">Organic fertilizers: Everything You Need to Know</span>
          </nav>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <header className="mb-12">
          ...
          <div className="flex flex-wrap gap-2 mt-6">
            <span className="bg-[#2E7D32] text-[#2E7D32] px-3 py-1 rounded-full text-sm font-semibold">organic fertilizers</span>
            <span className="bg-[#2E7D32] text-[#2E7D32] px-3 py-1 rounded-full text-sm font-semibold">organic fertilizers online</span>
            <span className="bg-[#2E7D32] text-[#2E7D32] px-3 py-1 rounded-full text-sm font-semibold">organic fertilizers india</span>
            <span className="bg-[#2E7D32] text-[#2E7D32] px-3 py-1 rounded-full text-sm font-semibold">buy organic fertilizers</span>
            <span className="bg-[#2E7D32] text-[#2E7D32] px-3 py-1 rounded-full text-sm font-semibold">best organic fertilizers</span>
          </div>
        </header>
