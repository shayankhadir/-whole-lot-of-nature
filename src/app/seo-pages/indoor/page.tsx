/**
 * SEO Landing Page: Indoor - Tips, Tricks & Complete Guide
...
export const metadata: Metadata = {
  title: 'Indoor - Tips, Tricks & Complete Guide | Whole Lot of Nature',
  ...
  openGraph: {
    title: 'Indoor - Tips, Tricks & Complete Guide',
    description: 'Discover everything about indoor with our comprehensive guide. Expert tips, best practices, and actionable advice for indoor. Shop now!',
    type: 'article',
  },
};
      ...
      <div className="bg-white border-b">
        <div className="max-w-6xl mx-auto px-4 py-3">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-100">/</span>
            <span className="text-gray-100">Indoor - Tips, Tricks & Complete Guide</span>
          </nav>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <header className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 antialiased">
            Indoor - Tips, Tricks & Complete Guide
          </h1>
          ...
          <div className="flex flex-wrap gap-2 mt-6">
            <span className="bg-[#2E7D32] text-[#2E7D32] px-3 py-1 rounded-full text-sm font-semibold">indoor</span>
            <span className="bg-[#2E7D32] text-[#2E7D32] px-3 py-1 rounded-full text-sm font-semibold">indoor online</span>
            <span className="bg-[#2E7D32] text-[#2E7D32] px-3 py-1 rounded-full text-sm font-semibold">indoor india</span>
            <span className="bg-[#2E7D32] text-[#2E7D32] px-3 py-1 rounded-full text-sm font-semibold">buy indoor</span>
            <span className="bg-[#2E7D32] text-[#2E7D32] px-3 py-1 rounded-full text-sm font-semibold">best indoor</span>
          </div>
        </header>
