    ...
    <div className="bg-white">
      ...
      <section className="bg-gradient-to-br from-primary-50 to-primary-100 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="mt-4 text-4xl md:text-5xl font-bold text-gray-900 antialiased">Privacy Policy</h1>
      ...
      <div className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 antialiased">1. Information We Collect</h2>
            
            <h3 className="text-xl font-semibold text-gray-800 mb-3 antialiased">Personal Information</h3>
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3 antialiased">Information Collected Includes:</h3>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 antialiased">2. Automatic Information Collection</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 antialiased">3. How We Use Your Information</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 antialiased">4. Information Sharing and Disclosure</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              We may share your information with:
            </p>
            
            <h3 className="text-xl font-semibold text-gray-800 mb-3 antialiased">Service Providers:</h3>
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3 antialiased">Legal Requirements:</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 antialiased">5. Cookies and Tracking Technologies</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 antialiased">6. Data Security</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 antialiased">7. Your Rights and Choices</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 antialiased">8. Marketing Communications</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 antialiased">9. Third-Party Links</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 antialiased">10. Children's Privacy</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 antialiased">11. Data Retention</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 antialiased">12. Changes to This Policy</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4 antialiased">13. Contact Us</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <div className="mt-12 p-6 bg-blue-50 rounded-lg border border-blue-200">
            <h3 className="text-lg font-semibold text-gray-900 mb-3 antialiased">Your Privacy Matters</h3>
