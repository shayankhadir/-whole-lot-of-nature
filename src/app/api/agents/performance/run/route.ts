...
export async function GET() {
  try {
    // Find the latest performance report dynamically in a dedicated directory
    ...
    const files = fs.readdirSync(searchDir).filter(file => file.startsWith('performance-report-') && file.endsWith('.json'));
